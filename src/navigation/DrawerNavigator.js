...
const CustomDrawer = () => {
  ...
  return (
    <View style={{ backgroundColor: '#DDDDDD',alignItems:"center",justifyContent:'center',width:'100%',height:'100%' }}>
      ...
      <ScrollView contentContainerStyle={{alignItems:'center'}} style={{ width: '100%',height:'100%',backgroundColor:'white'}} >
        ...
        <TouchableOpacity style={{ backgroundColor: ternaryThemeColor, height: 50, justifyContent: 'center', width: '60%',marginTop:10,borderRadius:4,alignItems:'center' }} onPress={() => {
         
          handleLogout()
          
          
        }}>
          <PoppinsTextLeftMedium style={{ color: 'white',fontWeight:'700',fontSize:16}} content="LOG OUT -->"></PoppinsTextLeftMedium>
        </TouchableOpacity>
