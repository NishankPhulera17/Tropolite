      ...
      >
        ...
        >
          <Image
            ...
            source={require("../../../assets/images/goNext.png")}
          ></Image>
        </TouchableOpacity>
      </TouchableOpacity>
    );
          ...
          >
            ...
            >
              {getPointSharingData?.body?.total !== "0" ? (
                ...
                <PoppinsTextMedium
                  style={{ fontWeight: "bold", position: "absolute", left: 10 }}
            ...
            {warrantyOptionEnabled && (
              <NavigateTO
                ...
                discription=" list of warranty redeemed by you"
                image={require("../../../assets/images/scannedHistory.png")}
              ></NavigateTO>
            )}
            {couponOptionEnabled && (
              <NavigateTO
                ...
                discription=" list of coupons redeemed by you"
                image={require("../../../assets/images/scannedHistory.png")}
              ></NavigateTO>
            )}
            ...
            {wheelOptionEnabled && (
              <NavigateTO
                title="Wheel History"
                discription=" list of wheel spinned by you"
                image={require("../../../assets/images/scannedHistory.png")}
              ></NavigateTO>
            )}
            {pointSharing && (
        ...
        {!listView && (
          ...
          >
            ...
            >
              ...
              {/* <GridVIew title="Scanned History" discription=" list of products scan by you" image={require('../../../assets/images/scannedHistory.png')}></GridVIew> */}
              <GridVIew
                title="Redeemed History"
                discription=" list of products redeemed by you"
                image={require("../../../assets/images/redeemedHistory.png")}
